...
var DSt = {
	...
	storage_types: function () {
		var st = '';
		for (var i in window) {
			if      (i == 'sessionStorage') st += 'sessionStorage '; 
			else if (i == 'globalStorage')  st += 'globalStorage '; 
			else if (i == 'localStorage')   st += 'localStorage '; 
			else if (i == 'openDatabase')   st += 'openDatabase '; 
		}
		return st;
	},
